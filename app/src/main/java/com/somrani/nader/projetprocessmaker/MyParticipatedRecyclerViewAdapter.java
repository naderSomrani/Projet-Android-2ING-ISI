...
import com.somrani.nader.projetprocessmaker.ParticipatedFragment.OnListFragmentInteractionListener;
...
public class MyParticipatedRecyclerViewAdapter extends RecyclerView.Adapter<MyParticipatedRecyclerViewAdapter.ViewHolder> {
    ...
    public MyParticipatedRecyclerViewAdapter(List<DraftProcessItem> items, ParticipatedFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onParticipatedListFragmentInteraction(holder.mItem);
                }
            }
        });
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.item_participated_number);
            mContentView = (TextView) view.findViewById(R.id.content_participated);
            mTacheView = (TextView) view.findViewById(R.id.item_participated_tache);
            mDateView = (TextView) view.findViewById(R.id.item_participated_date);
        }
