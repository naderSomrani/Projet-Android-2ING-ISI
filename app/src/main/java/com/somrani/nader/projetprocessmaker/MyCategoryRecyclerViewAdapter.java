...
import com.somrani.nader.projetprocessmaker.CategoryFragment.OnListFragmentInteractionListener;
...
public class MyCategoryRecyclerViewAdapter extends RecyclerView.Adapter<MyCategoryRecyclerViewAdapter.ViewHolder> {
    ...
    public MyCategoryRecyclerViewAdapter(List<String> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
